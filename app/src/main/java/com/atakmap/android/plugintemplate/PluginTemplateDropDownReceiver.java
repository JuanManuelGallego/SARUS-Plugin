...
public class PluginTemplateDropDownReceiver extends DropDownReceiver implements
    ...
    private String extractGeoFenceData(GeoFence geoFence)
    {
        ...
        if(mapItem == null) {
            debugText.setText("MapItem is null");
        ...
        if(mapItemShape == null) {
            debugText.setText("mapItemShape is null");
            return "Error, could not parse GeoFence, mapItem is null";
        }
        ...
        if(mapItem instanceof DrawingCircle)
        {
            ...
            toast("GeoFence is a Circle: " + circle.getRadius() + ", color: " + mapItemShape.getFillColor() + ", " + extractGeoFenceType(mapItemShape));
        }
        else if(mapItem instanceof DrawingShape)
        {
            ...
            toast("GeoFence is a DrawingShape, color: " + mapItemShape.getFillColor() + ", " + extractGeoFenceType(mapItemShape));
        }
        else if(mapItemShape.getType().equals(RECTANGLE) || mapItemShape.getType().equals(POLYLINE))
        {
            builder.append(extractGeoFenceType(mapItemShape))
                      .append(',')
                      .append("POLYGON")
            ...
            toast("GeoFence is a SHAPE, color: " + mapItemShape.getFillColor() + ", " + extractGeoFenceType(mapItemShape));
        }
...
//
        //    default:
        //        toast("Error, could not parse GeoFence, Shape not supported");
        //}
