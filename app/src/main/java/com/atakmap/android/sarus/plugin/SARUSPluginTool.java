...
import com.atakmap.android.sarus.SARUSPluginDropDownReceiver;
...
public class SARUSPluginTool extends Tool implements ToolDescriptor {

    private final Context context;

    public SARUSPluginTool(Context context) {
    ...
    public Drawable getIcon() {
        return (context == null) ? null
                : context.getResources().getDrawable(R.drawable.sarus);
    }
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                SARUSPluginDropDownReceiver.SHOW_PLUGIN);
